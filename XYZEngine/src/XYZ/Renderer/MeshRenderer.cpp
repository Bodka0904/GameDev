...
namespace XYZ {
	...
	void MeshRenderer::BeginScene(const SceneMeshRenderData& data)
	{
		s_Data.Data = data;
	}
	...
	void MeshRenderer::SubmitMesh(const glm::mat4& transform, const Ref<Mesh>& mesh)
	{
