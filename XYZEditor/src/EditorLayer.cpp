...
namespace XYZ {
	...
	void EditorLayer::OnAttach()
	{
		...
		{	
			...
			//m_FloorTest.Connect(pointOne, pointThree);
			//m_FloorTest.Connect(pointThree, pointFour);
			//m_FloorTest.Connect(pointOne, pointFour);
			...
			//m_FloorTest.Connect(tenthPoint, firstPoint);
